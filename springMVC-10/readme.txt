...
springMVC-08
    转发和重定向
        ...
        http://localhost:8888//springMVC_08_war_exploded/doForward.do?username=%E6%9D%8E%E6%98%8E&userage=23
        http://localhost:8888//springMVC_08_war_exploded/doRedirect.do?username=%E6%9D%8E%E6%98%8E&userage=23
        http://localhost:8888/springMVC_08_war_exploded/WEB-INF/view/show.jsp?msg=%E5%AE%9E%E7%8E%B0%E9%87%

springMVC-09
    异常处理步骤:
        1.新建自定义异常类，myUserException, 在定义它的子类NameException,AgeException
        2.在controller中抛出NameException, AgeException
        3.创建一个普通类，作为全局异常处理类
            * 在类的上面加入@ControllerAdvice
            * 在类中定义方法，方法的上面加入@ExceptionHandler注解
        4.创建处理异常的视图页面
        5.创建springmvc的配置文件
